...
<head>
  ...
  <link rel="stylesheet" href="{{asset('Theme2/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
  <!-- iCheck -->
...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  {{-- <div class="preloader flex-column justify-content-center align-items-center">
   <img class="animation__shake" src="{{asset('Theme2/dist/img/AdminLTELogo.png')}}" alt="AdminLTELogo" height="60" width="60">
 </div> --}}
      ...
      <div id="wrapper">
         ...
         @include('Admin.Admin Layout.nav')
