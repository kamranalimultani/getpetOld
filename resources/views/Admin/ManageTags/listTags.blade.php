...
<div class="card-body">
   <div>
      ...
      <a href="{{url('admin/posts/tags/add')}}" class="float-right btn btn-primary m-2">Add Tag</a>
    ...
    <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
      <thead>
         <tr role="row">
            ...
            <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending"  >Tag Name</th>
     ...
     <tbody id="ProductTable">
         @include('Admin.ManageTags.TagsTable')
     </tbody>
     </table>
</div>
</div>
