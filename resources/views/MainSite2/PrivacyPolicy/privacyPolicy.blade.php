@extends('MainSite2.index',['title'=>'GetPet.in | Privacy Policies','tags'=>'getpet.in, how to sell pets in india,pet shops near me,pet shops in nagina','description'=>'getpet.in is an open source platform to buy and sell pets in india,all type of exotic birds,dogs,cats,and reptiles. Pets will be home delivered to your home easily at best price'])
@section('content')
@include('MainSite2.Common.BreadCrum',['backPage'=>'Pages','backPageUrl'=>'/','currentPage'=>"Privacy Policies",'currentPageUrl'=>'/privacy-policies','desc'=>'Welcome to our pet store! We are a pet shop that specializes in all things related to pets.'])
...
<section class="section section-sm section-last bg-default text-start">
  <div class="container grid-system-bordered grid-demonstration">
    ...
    <div class="row">
      <div class="col-12">
        <dl class="list-terms list-terms-1 d-flex flex-column justify-content-center ">
        ...
        <div class="text-center">
          <a style="color: red" href="mailto:getpet64@gmail.com"><i class="fa-solid fa-envelope"></i>  info@getpet.in</a>
